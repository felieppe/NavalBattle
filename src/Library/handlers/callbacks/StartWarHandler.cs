//---------------------------------------------------------------------------------
// <copyright file="StartWarHandler.cs" company="Universidad Católica del Uruguay">
...
{
    /// <summary>
    /// Un "Handler" del patrón Chain of Responsibility que implementa el comando "start_war".
    /// </summary>
    public class StartWarHandler : BaseHandler
    {
        ...
        /// <summary>
        /// Procesa el mensaje "start_war" y retorna true; retorna false en caso contrario.
        /// </summary>
